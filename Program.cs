...
namespace Calculadora
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var segundoNumeroValidoString = Console.ReadLine();
            float segundoNumero;

            bool isSegundoNumeroValido = float.TryParse(segundoNumeroValidoString, out segundoNumero);
            ...
            Console.WriteLine("O resultado da operação matemática foi:" + resultado);
